...
actor ProgressMetadataService {
    ...
    func resetAllProgress() async throws {
        ...
        try deleteAll(CharacterSkillRecord.self, context: context)
        try deleteAll(CharacterEquipmentRecord.self, context: context)
        try deleteAll(CharacterJobHistoryRecord.self, context: context)
        try deleteAll(CharacterExplorationTagRecord.self, context: context)
        ...
        try deleteAll(ExplorationRunMemberRecord.self, context: context)
        try deleteAll(ExplorationEventRecord.self, context: context)
        try deleteAll(ExplorationEventExperienceRecord.self, context: context)
