// ==============================================================================
// BattleEnemyGroupConfigService.swift
// Epika
// ==============================================================================
//
// 【責務】
//   - ダンジョンの敵グループ構成ルールに基づくエンカウント生成
//   - フロア別敵プールとノーマルプールの混合制御
//   - 敵の数と種類の決定
//
// 【データ構造】
//   - GroupEnemy: グループ内の敵定義と出現数
//
// 【公開API】
//   - makeEncounter: 敵グループの構成を生成
//
// 【使用箇所】
//   - BattleEnemyGroupBuilder（敵グループ構築時）
//
// ==============================================================================
