...
//
// 【責務】
//   - キャラクターのヘッダー情報（名前、アバター画像）を表示・編集
//   - 名前変更とアバター変更機能を提供
//
// 【View構成】
//   - 左: CharacterImageView（60x60）+ 編集アイコン（onAvatarChangeがある場合）
//   - 右: 名前表示/編集フィールド + エラーメッセージ
//   - 編集モード: TextFieldで名前入力、フォーカス喪失/Enterキーで保存
//   - アバター変更: タップでCharacterAvatarSelectionSheetを表示
//
// 【使用箇所】
//   - キャラクター詳細画面（CharacterSectionType.name, characterImage）
//
// ==============================================================================
